...
import Hydrauli from "../../../assets/images/Hydraulic.jpeg";
  ...
  return (
    <div>
      ...
      <div className=" lb_product_wrap">
        <Heading style="center" title="Hydraulic Breaker" />
            ...
            <table className="responsive-table card z-depth-1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> </td>
                  <td>
                    <img width={100} src={Hydrauli} alt="" />
                  </td>
                  <td>
                    <img width={120} src={Hydrauli} alt="" />
                  </td>
                  <td>
                    <img width={140} src={Hydrauli} alt="" />
                  </td>
                  <td>
                    <img width={160} src={Hydrauli} alt="" />
                  </td>
                </tr>
              </tbody>
            </table>
